...
- `embedding_base.py`：embedding provider 抽象
- `deterministic_embedding_provider.py` / `openai_embedding_provider.py`：embedding provider 实现
- `embedding_registry.py`：embedding provider 工厂
