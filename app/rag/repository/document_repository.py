...
from app.rag.repository.mappers import map_document_entity_to_record
from app.rag.repository.models import ChunkEntity, DocumentEntity
from app.rag.repository.read_models import DocumentRecord
...
class DocumentRepository:
    ...
    def upsert_document(
        ...
        *,
        ...
        with self._database_runtime.session_scope() as session:
            ...
            session.flush()
            return map_document_entity_to_record(entity)
    ...
    def list_documents(self) -> list[DocumentRecord]:
        with self._database_runtime.session_scope() as session:
            ...
            return [map_document_entity_to_record(entity) for entity in entities]
